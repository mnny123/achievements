...
- **Adjustment points.** Any achievement can be marked *adjustable* when it's created or suggested. Logging an adjustable achievement opens a small panel to add extra points on top of the base (or subtract some) to match the circumstances; the adjustment shows in the live feed, toasts, and score totals.
